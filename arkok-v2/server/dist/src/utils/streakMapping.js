...
exports.QC_STREAK_MAPPING = void 0;
exports.getStreakCategory = getStreakCategory;
exports.QC_STREAK_MAPPING = {
    // === 语文 Chinese ===
...
function getStreakCategory(taskTitle) {
    // 1. 精确匹配
    if (exports.QC_STREAK_MAPPING[taskTitle]) {
        return exports.QC_STREAK_MAPPING[taskTitle];
    }
    // 2. 关键词模糊匹配 (可以根据需要调整优先级)
    for (const key in exports.QC_STREAK_MAPPING) {
        if (taskTitle.includes(key)) {
            return exports.QC_STREAK_MAPPING[key];
        }
    }
    return null;
}
//# sourceMappingURL=streakMapping.js.map