...
const checkin_service_1 = __importDefault(require("./services/checkin.service")); // Added
...
const reading_service_1 = require("./services/reading.service");
...
const parent_routes_1 = require("./routes/parent.routes");
...
const reading_routes_1 = __importDefault(require("./routes/reading.routes")); // 🆕 阅读计划路由
const skill_routes_1 = __importDefault(require("./routes/skill.routes")); // 🆕 五维内功技能路由
const streak_routes_1 = require("./routes/streak.routes"); // 🆕 连胜系统路由
// Middleware & Utils
...
class App {
    constructor() {
        ...
        skill_service_1.skillService.setSocket(this.io);
        // 1. 初始化所有单例服务
        ...
        this.checkinService = new checkin_service_1.default(this.prisma);
        ...
        this.readingService = new reading_service_1.ReadingService(this.prisma);
        this.parentService = new parent_service_1.ParentService(this.prisma);
    ...
    initializeRoutes() {
        ...
        this.app.use('/api/mistakes', new mistakes_routes_1.MistakesRoutes(this.authService, this.prisma).getRoutes());
        ...
        // 家长端路由
        this.app.use('/api/parent', new parent_routes_1.ParentRoutes(this.parentService).getRoutes());
        // 积分经验配置路由
        this.app.use('/api/reward', reward_routes_1.default);
        // 签到路由
        this.app.use('/api/checkins', new checkin_routes_1.default(this.checkinService, this.authService).getRoutes());
        // 🆕 阅读计划路由
        this.app.use('/api/reading', new reading_routes_1.default(this.readingService, this.authService).getRoutes());
        // 🆕 五维内功技能路由
